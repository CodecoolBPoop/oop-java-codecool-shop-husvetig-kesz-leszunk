...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product("Laser Pistol", 999.9f, "USD", "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", weapon, amazon));
        productDataStore.add(new Product("Lenovo IdeaPad Miix 700", 479, "USD", "Keyboard cover is included. Fanless Core m5 processor. Full-size USB ports. Adjustable kickstand.", tablet, lenovo));
        productDataStore.add(new Product("Amazon Fire HD 8", 89, "USD", "Amazon's latest Fire HD 8 tablet is a great value for media consumption.", tablet, amazon));
        productDataStore.add(new Product("Spaceship Engine", 11990, "USD", "Amazon's latest Fire HD 8 tablet is a great value for media consumption.", spaceShipPart, amazon));
        productDataStore.add(new Product("Hyper drive", 8980, "USD", "Amazon's latest Fire HD 8 tablet is a great value for media consumption.", spaceShipPart, lenovo));
